...
public class NotificacionesActivity extends AppCompatActivity implements
    ...
    public void onSwipe(RecyclerView.ViewHolder viewHolder, int direction, int position) {
        if (viewHolder instanceof RViewAdapter.DataObjectHolder) {
            ...
            String nombre = getListaNotificaciones().get(viewHolder.getAdapterPosition()).getNombre();
            final Notificaciones notificacionBorrada = getListaNotificaciones().get(viewHolder.getAdapterPosition());
